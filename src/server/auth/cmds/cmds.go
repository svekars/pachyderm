...
func ActivateCmd(noMetrics *bool) *cobra.Command {
...
func DeactivateCmd(noMetrics *bool) *cobra.Command {
...
func LoginCmd(noMetrics *bool) *cobra.Command {
	var useOTP bool
	login := &cobra.Command{
		Use:   "login",
...
// credential, logging you out of your cluster. Note that this is not necessary
// to do before logging in as another user, but is useful for testing.
func WhoamiCmd(noMetrics *bool) *cobra.Command {
...
func CheckCmd(noMetrics *bool) *cobra.Command {
	check := &cobra.Command{
...
func GetCmd(noMetrics *bool) *cobra.Command {
...
func SetScopeCmd(noMetrics *bool) *cobra.Command {
	setScope := &cobra.Command{
...
func ListAdminsCmd(noMetrics *bool) *cobra.Command {
...
// cluster admins
func ModifyAdminsCmd(noMetrics *bool) *cobra.Command {
	var add []string
	var remove []string
...
func GetAuthTokenCmd(noMetrics *bool) *cobra.Command {
	var quiet bool
...
func Cmds(noMetrics *bool) []*cobra.Command {
	...
	auth.AddCommand(ActivateCmd(noMetrics))
	auth.AddCommand(DeactivateCmd(noMetrics))
	auth.AddCommand(LoginCmd(noMetrics))
	auth.AddCommand(LogoutCmd())
	auth.AddCommand(WhoamiCmd(noMetrics))
	auth.AddCommand(CheckCmd(noMetrics))
	auth.AddCommand(SetScopeCmd(noMetrics))
	auth.AddCommand(GetCmd(noMetrics))
	auth.AddCommand(ListAdminsCmd(noMetrics))
	auth.AddCommand(ModifyAdminsCmd(noMetrics))
	auth.AddCommand(GetAuthTokenCmd(noMetrics))
